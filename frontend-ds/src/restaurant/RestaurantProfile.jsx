      ...
      <div className="flex-1 p-6 bg-gray-100 min-h-screen">
        {error ? (
          ...
          <div className="max-w-md mx-auto p-6 bg-white shadow-lg rounded-lg">
            ...
            <p><strong>Cuisine Type:</strong> {profile.cuisineType}</p>
            ...
            <div className="flex items-center justify-between mt-6">
              ...
              <label className="inline-flex relative items-center cursor-pointer">
                <input
                  ...
                  disabled={updating}
                />
                <div className="w-11 h-6 bg-gray-300 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-blue-400 rounded-full peer dark:bg-gray-400 peer-checked:bg-green-500 after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:after:translate-x-full" />
              </label>
            </div>
          </div>
        )}
